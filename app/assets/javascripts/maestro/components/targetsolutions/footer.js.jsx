      ...
      <nav className="navbar navbar-inverse" id="footer">
        <div className="container-fluid">
          ...
          <ul className="nav navbar-nav navbar-right">
            <li><a href="http://www.targetsolutions.com/" target="_blank"><img src="http://app.targetsolutions.com/tsapp/dashboard/pl_fb/library/images/pro/targetsolutions.png" alt="TargetSolutions Logo"/></a></li>
          </ul>
        </div>
      </nav>
    );
